    ...
    return (
        <div className='py-[30px] px-3 lg:px-5'>
            ...
            <div className='flex items-center justify-between mt-[30px]'>
                <Link to='/doctors' className='w-[44px] h-[44px] border border-solid border-[#181a1E] rounded-full mt-[30px] flex items-center justify-center group hover:bg-primaryColor hover:border-none' >
