...
import heroImg07 from "../assets/images/hero-img07.png";
          ...
          <div className="container">
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="mt-5">
                    ...
                    Morbi sed accumsan ipsum. Vivamus nisl leo, condimentum ut
                    mauris quis, venenatis feugiat eros. Sed et erat fringilla,
                    feugiat ipsum quis, elementum nunc.
                  </p>
                  <Link to="doctors">
                    <button className="btn transform transition-transform duration-100 ease-in-out active:scale-95 active:bg-blue-700">
                      Request appointment
                    </button>
                  </Link>
                </div>
                ...
                <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
                  ...
                  <div>
                    <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor">
                      <CountUp start={0} end={99.8} duration={2} decimals={1} />
                      %
                    </h2>
              ...
              <div className="flex gap-[30px] justify-end">
                <div className="mt-[30px] transition-all duration-1000 ease-in-out">
                  <img
                    className="w-full mb-[30px] rounded-lg shadow-lg transition-transform duration-1000 ease-in-out transform"
                    src={imageOrder[0]}
                    alt="Our Team Member"
                    style={{ transform: "rotate(3deg)" }}
                  />
                  <img
                    className="w-full rounded-lg shadow-lg transition-transform duration-1000 ease-in-out transform"
                    src={imageOrder[1]}
                    alt="Our Team Member"
                    style={{ transform: "rotate(-3deg)" }}
                  />
          ...
          <div className="container mx-auto">
            <div className="text-center max-w-xl mx-auto mb-12">
              ...
              <p className="text-lg text-gray-600">
                Experience top-tier healthcare with our trusted
                professionals.Lorem ipsum dolor sit amet, consectetur adipiscing
                elit. Morbi sed accumsan ipsum. Vivamus nisl leo, condimentum ut
                mauris quis, venenatis feugiat eros. Sed et erat fringilla.
              </p>
            </div>
        ...
        <section className="bg-gray-50 py-16">
          <div className="container mx-auto">
            <div className="text-center max-w-xl mx-auto mb-12">
              ...
              <p className="text-lg text-gray-600">
                Providing high-quality, personalized healthcare. We ensure every
                patient gets the best treatment and care.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  early. Our general checkup service ensures you stay on top of
                  your health.
                </p>
                <Link
                  to="/doctors"
              ...
              <div className="group bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-6">
                  Our expert surgeons provide top-tier surgical care with
                  state-of-the-art equipment and facilities to ensure the best
                  outcomes.
                </p>
                <Link
                  to="/doctors"
              ...
              <div className="group bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 mb-6">
                  We provide specialized healthcare services for children,
                  ensuring their well-being and healthy growth from infancy to
                  adolescence.
                </p>
                <Link
                  to="/doctors"
              ...
              <div className="xl:w-[670px]">
                ...
                <ul className="pl-4">
                  <li className="text__para">
                    1. Schedule a virtual visit with a doctor from the comfort
                    of your home.
                  </li>
                  <li className="text__para">
                  ...
                  <li className="text__para">
                    3. View doctors who accepts new patients and use online tool
