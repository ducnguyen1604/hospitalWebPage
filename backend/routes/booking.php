...
// Routing based on URL path using switch
switch ($url) {
        // Route for posting available time slots for a doctor
    case preg_match('/\/hospitalWebPage\/backend\/api\/v1\/bookings\/doctors\/' . $doctorId . '\/timeSlots/', $url):
        ...
        // More future cases can be added here for other doctor actions or routes
    default:
